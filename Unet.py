...
Llayer2_2 = kr.layers.Conv2D( filters= 8, kernel_size=(4,4), activation='relu' , padding='same' )(Llayer2_1)
Llayer2_3 = kr.layers.Conv2D( filters= 16, kernel_size=(4,4), activation='relu' , padding='same' )(Llayer2_2)

#Left thrid block:
Llayer3_1 = kr.layers.MaxPool2D()(Llayer2_3)
Llayer3_2 = kr.layers.Conv2D( filters= 32, kernel_size=(4,4), activation='relu' , padding='same' )(Llayer3_1)
Llayer3_3 = kr.layers.Conv2D( filters= 64, kernel_size=(4,4), activation='relu' , padding='same'  )(Llayer3_2)

#Left fourth block:
Llayer4_1 = kr.layers.MaxPool2D()(Llayer3_3)
Llayer4_2 = kr.layers.Conv2D( filters= 128, kernel_size=(4,4), activation='relu' , padding='same'  )(Llayer4_1)
Llayer4_3 = kr.layers.Conv2D( filters= 256, kernel_size=(4,4), activation='relu' , padding='same'  )(Llayer4_2)

#Right thrid block:
Rlayer3_1_2 = kr.layers.UpSampling2D()(Llayer4_3)
Rlayer3_1 = kr.layers.concatenate([Llayer3_3, Rlayer3_1_2], axis=-1)
Rlayer3_2 = kr.layers.Conv2D( filters= (64+256)//2, kernel_size=(4,4), activation='relu' , padding='same'  )(Rlayer3_1)
...
Rlayer1_4 = kr.layers.Conv2D( filters= 4, kernel_size=(4,4), activation='relu' , padding='same' )(Rlayer1_3)
Rlayer1_5 = kr.layers.Conv2D( filters= 2, kernel_size=(4,4), activation='relu' , padding='same' )(Rlayer1_4)
Rlayer1_6 = kr.layers.Conv2D( filters= 1, kernel_size=(4,4), activation='relu' , padding='same' )(Rlayer1_5)
