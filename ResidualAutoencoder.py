...
model_name = "ResidualAutoEncoder-0.0-64x64"

inputs = Input(shape=(64,64,1))
layer_1 = Conv2D(filters = 1, kernel_size = 4, padding = 'same', activation = 'relu')(inputs)
layer_2 = Add()([layer_1, inputs])
layer_3 = Conv2D(filters = 10, kernel_size = 4, padding = 'same', activation = 'relu')(layer_2)
layer_4 = Conv2D(filters = 20, kernel_size = 4, padding = 'same', activation = 'relu')(layer_3)
layer_5 = Conv2D(filters = 10, kernel_size = 4, padding = 'same', activation = 'relu')(layer_4)
