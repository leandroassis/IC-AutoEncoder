...
model_name = "AutoEncoder-1.4-64x64"

inputs = Input(shape=(64,64,1))
layer_1 = Conv2D(filters = 2, kernel_size = 3, padding = 'same', activation = 'relu')(inputs)
layer_2 = MaxPooling2D()(layer_1)
layer_3 = Conv2D(filters = 2, kernel_size = 3, padding = 'same', activation = 'relu')(layer_2)
layer_4 = MaxPooling2D()(layer_3)
layer_5 = Conv2D(filters = 3, kernel_size = 3, padding = 'same', activation = 'relu')(layer_4)
layer_6 = UpSampling2D()(layer_5)
layer_7 = Conv2D(filters = 2, kernel_size = 3, padding = 'same', activation = 'relu')(layer_6)
